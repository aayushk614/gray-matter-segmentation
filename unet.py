...
class UpConv(Module):
    def __init__(self, in_feat, out_feat, drop_rate=0.4, bn_momentum=0.1):
        ...
        self.downconv = Deconv(in_feat, out_feat, drop_rate, bn_momentum)
...
class Unet(Module):
    ...
    def __init__(self, drop_rate=0.4, bn_momentum=0.1):
        ...
        #Downsampling path
        self.conv1 = Deconv(1, 64, drop_rate, bn_momentum)
        self.mp1 = nn.MaxPool2d(2)

        self.conv2 = Deconv(64, 128, drop_rate, bn_momentum)
        self.mp2 = nn.MaxPool2d(2)

        self.conv3 = Deconv(128, 256, drop_rate, bn_momentum)
        self.mp3 = nn.MaxPool2d(2)

        # Bottom
        self.conv4 = Deconv(256, 256, drop_rate, bn_momentum)
